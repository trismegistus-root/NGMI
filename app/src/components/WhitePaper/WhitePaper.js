...
function WhitePaper() {
	  return (
           <div>
				...
				Just copy/paste your address, and the faucet will mint a token for you for free(exluding gas prices). 
				...
				<label for="faucet" id = "caption">Copy/Paste public address and hit enter: </label>
